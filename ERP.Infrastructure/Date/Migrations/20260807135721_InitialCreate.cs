        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesOrdersItems_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesOrdersItems_SalesOrders_SalesOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrdersItems_ProductId",
                table: "SalesOrdersItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesOrdersItems_SalesOrderId",
                table: "SalesOrdersItems",
                column: "SalesOrderId");
